...
The chunk named `Attr` is optional, but some OTP tools expect the attributes to be present. The release handler expect the "vsn" attribute to be present. You can get the version attribute from a file with: beam_lib:version(Filename), this function assumes that there is an attribute chunk with a "vsn" attribute present.
