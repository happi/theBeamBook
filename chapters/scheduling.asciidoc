...
erl_vm.h footnote:source-scheduling-erl-vm-h-otp-20-0[https://github.com/erlang/otp/blob/OTP-20.0/erts/emulator/beam/erl_vm.h],
...
struct. See erl_time.h footnote:source-scheduling-erl-time-h-otp-19-1[https://github.com/erlang/otp/blob/OTP-19.1/erts/emulator/beam/erl_time.h]. If several timers are
