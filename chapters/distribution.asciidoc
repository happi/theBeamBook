...
For a full description of the distribution on the Erlang level, including command-line flags, and helpful modules and functions read the reference manual on Distributed Erlang footnote:source-distribution-distributed-html[https://www.erlang.org/doc/reference_manual/distributed.html].
...
The protocol is described in detail in ERTS Reference:Distribution Protocol footnote:source-distribution-erl-dist-protocol-html[https://www.erlang.org/doc/apps/erts/erl_dist_protocol.html]
...
The Erlang documentation has a chapter on how to implement an alternative carrier footnote:source-distribution-alt-dist-html[https://www.erlang.org/doc/apps/erts/alt_dist.html].

It also has a chapter on how to implement an alternative node discovery footnote:source-distribution-alt-disco-html[https://www.erlang.org/doc/apps/erts/alt_disco.html].
...
2. This request is handled by the ERTS on Node 1.
