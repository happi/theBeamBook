...
`erlc` footnote:source-compiler-erlc-cmd-html[https://www.erlang.org/doc/apps/erts/erlc_cmd.html] for a complete
...
`compile` footnote:source-compiler-compile-html[http://www.erlang.org/doc/man/compile.html].
...
`erlc` footnote:source-compiler-erlc-cmd-html-supported-compilers[https://www.erlang.org/doc/apps/erts/erlc_cmd.html#supported-compilers].
****
...
`compile.erl` footnote:source-compiler-compile-erl-maint[https://github.com/erlang/otp/blob/maint/lib/compiler/src/compile.erl]
...
The Abstract Format footnote:source-compiler-absform-html[http://www.erlang.org/doc/apps/erts/absform.html] ) representing the
...
accordance with EEP 18
(Erlang Enhancement Proposal 18: "JSON bifs")] footnote:source-compiler-eep-0018-html[http://www.erlang.org/eeps/eep-0018.html]
...
(see leex footnote:source-compiler-leex[https://www.erlang.org/doc/apps/parsetools/leex.html]).

We can use the lexer generator to create an Erlang program which
recognizes JSON tokens. By looking at the JSON definition
The JSON Data Interchange Syntax footnote:source-compiler-ecma-404-pdf[http://www.ecma-international.org/publications/files/ECMA-ST/ECMA-404.pdf]
...
Erlang.org site: Erlang Syntax Tools footnote:source-compiler-syntax-tools[http://erlang.org/doc/apps/syntax_tools/chapter.html].
