...
Since L is a local function it will always retun X + 1. If the module is reloaded and foo/1 is changed to return X + 2 then F will return X + 2. If the module is reloaded twice
