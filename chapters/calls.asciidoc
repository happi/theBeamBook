...
Function call efficiency in Erlang follows a clear hierarchy, as outlined in the Efficiency Guide footnote:source-calls-eff-guide-functions-html-function-calls[https://www.erlang.org/doc/system/eff_guide_functions.html#function-calls]:
