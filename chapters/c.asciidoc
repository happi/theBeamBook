...
The official documentation contains a tutorial on interoperability, see Interoperability Tutorial footnote:source-c-introduction[https://www.erlang.org/doc/tutorial/introduction].
...
bif.c footnote:source-c-bif-c-master[https://github.com/erlang/otp/blob/master/erts/emulator/beam/bif.c]
or in this case perhaps in erl_math.c footnote:source-c-erl-math-c-master[https://github.com/erlang/otp/blob/master/erts/emulator/beam/erl_math.c]
...
Add the BIF to the list of BIFs in the file `bif.tab` footnote:source-c-bif-tab-master[https://github.com/erlang/otp/blob/master/erts/emulator/beam/bif.tab].
...
Then add a stub to the Erlang module `math.erl` footnote:source-c-math-erl-master[https://github.com/erlang/otp/blob/master/lib/stdlib/src/math.erl]:
...
See "Make all steps of term_to_binary work in chunks and yield" footnote:source-c-term-to-binary-yielding[https://github.com/erlang/otp/commit/47d6fd3ccf35a4d921591dd0a9b5e69b9804b5b0]
...
How to use NIFs is nowadays well documented in the Interoperability Tutorial footnote:source-c-introduction[] in the
NIF section footnote:source-c-nif-html[https://www.erlang.org/doc/system/nif.html], but we will go through the basics here.
