...
HiPE group. (See
A staged tag scheme for Erlang footnote:source-type-system-2000-029[http://www.it.uu.se/research/publications/reports/2000-029/])
The ((tagging scheme)) is implemented in
erl_term.h footnote:source-type-system-erl-term-h-otp-23-0[https://github.com/erlang/otp/blob/OTP-23.0/erts/emulator/beam/erl_term.h].
