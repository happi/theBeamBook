...
A Brief History of the BEAM Compiler footnote:source-beam-beam-compiler-history[https://www.erlang.org/blog/beam-compiler-history/]
****
...
`erl_scan` footnote:source-beam-erl-scan-html[https://erlang.org/doc/man/erl_scan.html] and
`erl_parse` footnote:source-beam-erl-parse-html[https://erlang.org/doc/man/erl_parse.html] we
...
The BEAM instruction `test_heap` footnote:source-beam-genop-tab-otp-23-0-l118[https://github.com/erlang/otp/blob/OTP-23.0/lib/compiler/src/genop.tab#L118]
