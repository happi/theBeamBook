...
For more detailed information, refer to the official documentation at erlang.org:io_protocol footnote:source-io-io-protocol-html[https://www.erlang.org/doc/apps/stdlib/io_protocol.html].
...
See xref:CH-C[] for examples of how to spawn an external program as a port. You can also look at the official documentation: erlang.org:c_port footnote:source-io-c-port-html-content[https://www.erlang.org/doc/system/c_port.html#content].
...
See xref:CH-C[] for examples of how to implement and spawn a linked in driver as a port. You can also look at the official documentation: erlang.org:c_portdriver footnote:source-io-c-portdriver-html-content[https://www.erlang.org/doc/system/c_portdriver.html#content].
...
erlang.org:c-driver footnote:source-io-c-portdriver-html-c-driver[https://www.erlang.org/doc/system/c_portdriver.html#c-driver].
