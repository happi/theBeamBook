...
unfortunately has been lost in time. 

// TODO: Rewrite using  Erlang Pathologist Toolkit
...
Here's an expanded explanation about generations, using the additional information from your document:
