...
((Erlang on Xen)) (LING footnote:source-introduction-ling[https://github.com/cloudozer/ling]) is an Erlang implementation
...
((Erjang)) (Erjang project footnote:source-introduction-erjang[https://github.com/trifork/erjang]) is an Erlang implementation which runs
