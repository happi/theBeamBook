...
INSTALL.html footnote:source-building-install-html[http://www.erlang.org/doc/installation_guide/INSTALL.html].
...
kerl footnote:source-building-kerl[https://github.com/spawngrid/kerl].
...
Github footnote:source-building-otp[https://github.com/erlang/otp].
