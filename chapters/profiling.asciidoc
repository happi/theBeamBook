...
Let us qickly recap some of the key concepts we have covered in this book so far.
...
Recon and redbug are ommunity-driven libraries that packs a punch in runtime diagnostics.  Both are designed for real-world use, and they are lightweight enough to drop into production systems for on-demand troubleshooting. 
